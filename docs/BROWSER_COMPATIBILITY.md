...
Pixel Studio requires modern browser features and does not include polyfills or backward compatibility code. The following features are **required**:
...
**Note**: Older browsers that do not support these features will not be able to run Pixel Studio. This is intentional to maintain code quality and performance.
