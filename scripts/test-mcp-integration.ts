...
async function testFallbacks(): Promise<IntegrationTestResult> {
  ...
  try {
    ...
    if (suggestion.suggestion.includes('Error details not available') ||
...
export { runIntegrationTests, testContext7Integration, testMemoryIntegration, testFallbacks, testPerformance }
